...
function PinDetail({ user }) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
          ...
          <div className="flex items-center flex-wrap mt-6 gap-3">
            ...
            <button
              type="button"
              className="bg-red-500 text-white rounded-full p-6 py-2 font-semibol text-base outline-none"
              onClick={addComment}
            >
      ...
      {pins?.length > 0 ? (
        <>
          <h2 className="text-center font-bold tex-2xl mt-8 mb-4">
            {" "}
            More Like this
          </h2>
        ...
        <Spinner className="mt-4" message="loading more pins like this one!" />
      )}
    </>
  );
}
